...
namespace SimpleInvoiceSystem
{
    ...
    public class SimpleInvoiceSystemWebApiModule : AbpModule
    {
        public override void Initialize()
        {
            ...
            DynamicApiControllerBuilder
                .ForAll<IApplicationService>(Assembly.GetAssembly(typeof (SimpleInvoiceSystemApplicationModule)), "invoicesystem")
                .Build();
        }
    }
}
