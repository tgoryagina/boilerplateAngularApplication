...
namespace SimpleInvoiceSystem.EntityFramework.Repositories
{
    ...
    /// </summary>
    public class TaskRepository : SimpleInvoiceSystemRepositoryBase<Task, long>, ITaskRepository
    {
        public TaskRepository(IDbContextProvider<SimpleInvoiceSystemDbContext> dbContextProvider)
